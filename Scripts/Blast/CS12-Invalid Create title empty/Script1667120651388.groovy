...
Mobile.setText(findTestObject('Blast/android.widget.EditText - Title'), '', 0)

Mobile.setText(findTestObject('Blast/android.widget.EditText - Description'), findTestData('demo').getValue(2, 1), 0)
...
Mobile.tap(findTestObject('Blast/android.widget.Button Back'), 0)
